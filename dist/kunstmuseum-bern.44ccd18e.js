...
})({"fxPHT":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "d26ceaa444ccd18e";
"use strict";
...
const heatmap = async (nb, museum)=>{
  ...
  for await (const num of arts[museum]) {
    await getDomColor(num.image);
    break;
  }
*/ //console.log(element.artiste);
    //colorInfo.push(getDomColor(element.image));
    console.log(colorInfo);
    /*
  for (let i = 0; i < x; i++) {
    for (let j = 0; j < x; j++) {
      colorInfo.push(getDomColor(museum));
    }
  }
*/ // forEach(arts.museum, (art) => {
    //     colorInfo.push(getDomColor(art.image));
    // });
    // await all promise
    //const colorInfoArray = await Promise.all(colorInfo);
    //console.log(colorInfoArray);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fxPHT"], null, "parcelRequire6426")

//# sourceMappingURL=kunstmuseum-bern.44ccd18e.js.map
